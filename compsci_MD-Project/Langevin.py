...
###################################  timing ################################### 
### loop p = t-1 ###
get_ipython().run_line_magic('lprun', '-f langevin langevin(potential_gradient, p_0, v_0, m, 100., 0.001, 0., 1.0, pbc=True)')
get_ipython().run_line_magic('timeit', '-n 10 -r 10 langevin(potential_gradient, p_0, v_0, m, 100., 0.001, 0., 1.0, pbc=True)')
